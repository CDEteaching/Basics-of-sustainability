...
-   **A sustainable economy** strikes a balance between the two predominant approaches of green growth and degrowth. It strives for social well-being within planetary boundaries without dogmatically committing to either economic growth or shrinkage. Petschow et al. [-@petschowSocialWellBeingPlanetary2020], for example, describe this position as a *precautionary post-growth approach.*
...
Given that the sustainability challenges we face are systemic, we need companies that go far beyond efficiency increases: in other words, companies that are transformative. Hug et al. [-@hugTransformativeEnterprisesCharacteristics2022] describe transformative companies based on a synthesis of the nine key dimensions which resulted from their literature review:
