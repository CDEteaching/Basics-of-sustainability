...
Given that the sustainability challenges we face are systemic, we need companies that go far beyond efficiency increases: in other words, companies that are transformative. Hug et al. [-@hugTransformativeEnterprisesCharacteristics2022] describe such companies as follows:
