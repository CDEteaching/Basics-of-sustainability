...
Economic sustainability is a profoundly normative concept. It asks what kind of economy is socially desirable, which goals economic activity should pursue, whom it should serve, and within which social and ecological boundaries it must operate. Questions of economic growth, prosperity, work, distribution, and stability are therefore not merely technical issues, but central societal and political concerns that shape everyday life. At the same time, it has become increasingly clear that dominant economic models significantly contribute to the transgression of planetary boundaries, rising social inequalities, and the destabilization of socio-ecological systems.

Contrary to widespread belief, economic theories are not value-neutral descriptions of how the economy “works”. They are normative and performative: they shape political decisions, institutional arrangements, corporate practices, and individual action. As a result, answers to the core questions of economics -- who produces and consumes what and why, how profits are distributed, and what they are used for -- vary fundamentally depending on the underlying economic theory and its implicit assumptions about humans, society, and nature.
...
> Preface, p. 1 -- David Ricardo: *The Principles of Political Economy and Taxation* [-@ricardoPriniciplesPoliticalEconomy1821]

![Economic Sustainability. Source: Own illustration.](images/Fig5_1_NEeconomic.png){#fig-ne-econ}

Against this background, this chapter places capitalism as a historically specific mode of production and organization at the centre of analysis. Many sustainability challenges -- including climate change, structural growth dependency, and financial instability -- cannot be adequately understood without considering the systemic dynamics of contemporary capitalist economies. Rather than opposing “the market” and “sustainability” in a simplistic way, the chapter aims to develop a differentiated understanding of tensions, constraints, and transformation pathways towards a more sustainable economy.

## Economics as a performative science

From the very beginning, modern economics has not just observed and described social reality -- it has also helped shape it. This discipline has formed our thinking about what is considered “economic” -- e.g. through the ideal of the rationally deciding homo economicus, the norm of profit maximization, the focus on efficiency, or the idea that growth is synonymous with social progress [cf. @bontrupVolkswirtschaftslehreAusOrthodoxer2021, pp. 1-40].

These interpretations never remained purely theoretical. They continue to influence policy and practice to this day: from structural change to the market liberalization that took hold in the 1980s -- to the shaping of climate policy through emissions trading systems and the construction of highly complex financial products. The history of economics is therefore also a history of its impact [@schneidewindetalTransformativeWirtschaftswissenschaftIm2016]. The most widely accepted definition of economics, originally coined by Lionel Robbins, focuses on the relationship between resource scarcity and the satisfaction of people’s needs:

> “Economics is the science which studies human behaviour as a relationship between ends and scarce means which have alternatives uses.” [@robbinsEssayNatureSignificance1932, p. 15].
...
The heterodox economist Ha-Joon Chang criticizes Robbins’s definition as being too specific and as emerging from a theoretical approach, which subsequently causes it to prescribe a particular direction [@changEconomicsUsersGuide2014]. Chang defines economics not through a theoretical approach, but by its object of study: the economy. Economics is therefore the study of everything related to (re-)production, exchange, and distribution of goods and services for the satisfaction of human needs. There are of course many other definitions of economics. Building on these diverse understandings, various schools of thought consequently differ in their focus of study, which may include power structures, institutions, or macro-economic and social connections and structures [cf. @miyamuraAreWeAll2020; @newmanEffectsModernMonetary2025].
...
While a detailed exploration of neoclassical economics and other schools of thought is beyond the scope of this discussion, you can delve deeper into this topic in our [*Introduction to Sustainable Economics*](https://cdeteaching.github.io/SP_SustainableEconomics/){target="_blank"} course. More information on plural economics is also available on the [*Exploring Economics*](https://www.exploring-economics.org/en/){target="_blank"} e-learning platform.
...
{{< include "5-1_key-elements.qmd" >}}

{{< include "5-2_strategic-approaches.qmd" >}}

{{< include "quiz_ch5.qmd" >}}
