...
![Different ethical approaches. Source: Own illustration based on @carnauNachhaltigkeitsethikNormativerGestaltungsansatz2011 [pp. 143].](images/Anthropocentrism.png){#fig-anthropocentrism}
...
#| tbl-cap: "Overview of Development Debates. Source: Extended table based on @bieriGlobaleUngleichheitUnd2022 [p. 378]."

library(kableExtra)
is_pdf <- knitr::is_latex_output()

df <- data.frame(
  Category = c("Narrative", "Basic idea", "Theories", "Goals", "Consequences"),
  `1950s/60s` = c(
    "Reactive growth, modernization, and integration into the world economy",
    "Catch-up development through industrialization and large-scale projects", "Modernization theories (stage theories)","Geopolitical classification of the \u201cThird World\u201d; containment of communism, modernization of agriculture, rapid industrialization and technological progress, opening up of new markets", "Economic dependence and indebtedness increase, income disparities widen, poverty rises, ecological damage due to overuse and inappropriate technologies, undemocratic regimes are supported for geopolitical reasons"),
  `1970s` = c(
    "Fight against extreme poverty and inequality",
    "Satisfaction of basic needs, growth, and effective distribution", "Dependency theories versus modernization theories","Aid for self-help, appropriate technologies, rural development, promotion of women", "Selective progress in education and health, problems of debt and environmental damage"),
  `1980s` = c(
    "Lost decade: collapse of commodity prices; increase in debt",
    "Overcoming the debt crisis through structural adjustment measures, reduction of state services","Market liberalism and neoliberalism","Increase in exports, balanced state budgets", "Living standards of the poorest population groups deteriorate severely, environmental exploitation, debt spiral, increase of dependency of the Global South on Global North countries"),
  `1990s` = c(
    "Sustainable development; decade of hope",
    "Global sustainable environmental policy, economic growth, peacekeeping, continuing basic needs strategy, participation", "Theories of sustainable development, Neoclassical growth theory, Postcolonial theories, Capability approach, Post-development theories","Paradigm shift in development aid towards development cooperation, environmental and social compatibility of development, ensuring access to resources and infrastructure for all", "Focus shifts from purely economic development to human development; industrialized countries are obliged to implement sustainable development; emergence of a global development partnership"),
  `Since 2008` = c(
    "Polycrisis",
    "Bringing together various crisis phenomena (financial crisis, climate change, biodiversity crisis, etc.)","Additional resilience theories, post-growth theories", "", ""),
  check.names = FALSE
)
...
![Sustainability as an intersection. Source: Own illustration.](images/sustainability-intersection.png){#fig-sustainability-intersection}
...
![The nested model of sustainability. Source: Own illustration based on @giddingsEnvironmentEconomySociety2002 [pp. 192].](images/sustainability-nested.png){#fig-sustainability-nested}
...
![Four-dimensional model of sustainability. Source: Own illustration, adapted from @hawkesFourthPillarSustainability2001.](images/sustainability-4-dimensions.png){#fig-sustainability-4-dimensions}
...
#| tbl-cap: "Weak and Strong Sustainability. Source: Derived from @eblinghausNachhaltigkeitUndMacht1998; @michelsenStudienbriefGrundlagenNachhaltigen2012; and @daviesAppraisingWeakStrong2013."

library(kableExtra)
is_pdf <- knitr::is_latex_output()

df <- data.frame(
  Category = c("What should be preserved?", "Why?", "How? (Policies)", "Substitutability", "Ethics"),
  `Very Weak Sustainability` = c(
    "Total capital",
...
![Sustainability strategies. Source: Own illustration.](images/Fig1_12_sustainability-strategies.png){#fig-sustainability-strategies}
