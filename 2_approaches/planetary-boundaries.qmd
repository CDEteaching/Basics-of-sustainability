...
![Development of control variables for all nine planetary boundaries. Source: Azote for Stockholm Resilience Centre, Stockholm University. Based on @rockstromPlanetaryBoundariesExploring2009, @steffenPlanetaryBoundariesGuiding2015, @richardsonEarthSixNine2023. Licenced under CC BY-NC-ND 3.0.](Images/Fig2_1__planetaryboundaries.png){#fig-development-planetary-boundaries}

### Tipping points of the Earth’s climate system

![Spatial distribution of global and regional tipping elements. The colours indicate the temperature range in which tipping is likely to occur. Source: Designed at PIK, based on @armstrongmckayExceeding15degCGlobal2022, expanded with interactions based on @lentonClimateTippingPoints2019. Licenced under CC-BY.](Images/Tippingpoints.png){#fig-tippingspoints}
